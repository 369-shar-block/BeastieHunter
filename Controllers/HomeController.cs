...
using BeastieHunter.Models.ChartModels;
...
namespace BeastieHunter.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Dashboard()
        {
            ...
            model.Ticket = model.Projects.SelectMany(p => p.Tickets).Where(t => t.Archived == false).ToList();
        ...
        public IActionResult SeipkonIndex()
        {
            return View();
        }
