...
namespace BeastieHunter.Controllers
{
    ...
    public class InvitesController : Controller
    {
        ...
        public InvitesController(ApplicationDbContext context, IBTCompanyInfoService companyInfoService, IBTProjectService projectService, IBTFileService fileService, IBTLookupService lookupService, IBTRolesService rolesService, IBTInviteService inviteService, UserManager<BTUser> userManager, IEmailSender emailService, IDataProtectionProvider dataProtectionProvider)
        {
            _context = context;
            ...
            _protector = dataProtectionProvider.CreateProtector("CF.Starlink");
        }
