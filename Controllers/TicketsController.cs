...
namespace BeastieHunter.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public TicketsController(ApplicationDbContext context, IBTRolesService rolesService, IBTLookupService lookupService,
                                     IBTFileService fileService, IBTProjectService projectService, UserManager<BTUser> userManager, IBTCompanyInfoService companyInfoService, IBTTicketService ticketService, IBTTicketHistoryService historyService)
        {
            _context = context;
        ...
        public async Task<IActionResult> AssignDeveloper(AssignDeveloperViewModel model)
        {
            ...
            return RedirectToAction(nameof(AssignDeveloper), new { d = model.Ticket.Id });
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Created,Updated,Archived,ProjectId,TicketTypeId,TicketPriorityId,TicketStatusId,OwnerUserId,DevloperUserId")] Ticket ticket)
        {
            if (id != ticket.Id)
            {
                return NotFound();
